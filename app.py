...
_TPE_AMENITIES = [
    ...
    # ── 餐廳/午餐 ─────────────────────────────────
    {"id":53, "name":"員工餐廳",         "name_en":"Staff Cafeteria",                "category":"restaurant","terminal":"T1","floor":"B1F", "zone":"員工區",   "desc":"T1 地下一樓員工專用餐廳，從出境大廳搭電梯往 B1，依員工通道標示前進；中式套餐為主，午餐 11:00–14:00","desc_en":"T1 basement staff-only cafeteria. Take elevator to B1 from departure hall, follow staff corridor signs. Chinese set meals, lunch 11:00–14:00.","tags":["員工","午餐","餐廳","中餐","套餐","staff","cafeteria","lunch"]},
    {"id":54, "name":"員工餐廳",         "name_en":"Staff Cafeteria",                "category":"restaurant","terminal":"T2","floor":"B1F", "zone":"員工區",   "desc":"T2 地下一樓員工專用餐廳，從報到大廳搭電梯往 B1，依員工通道前進；提供中式／台式套餐，午餐 11:00–14:00","desc_en":"T2 basement staff-only cafeteria. Take elevator to B1 from check-in hall, follow staff signs. Chinese/Taiwanese set meals, lunch 11:00–14:00.","tags":["員工","午餐","餐廳","中餐","套餐","staff","cafeteria","lunch"]},
    {"id":55, "name":"麥當勞",           "name_en":"McDonald's",                     "category":"restaurant","terminal":"T1","floor":"3F",  "zone":"出境大廳（安檢前）","desc":"出境報到大廳中央，近 C 排報到區，24 小時營業，漢堡套餐快速取餐","desc_en":"Central departure hall, near Row C check-in. Open 24 hours. Burger combo meals, quick service.","tags":["麥當勞","漢堡","速食","午餐","快餐","McDonald","burger","fast food","lunch"]},
    {"id":56, "name":"麥當勞",           "name_en":"McDonald's",                     "category":"restaurant","terminal":"T2","floor":"3F",  "zone":"出境大廳", "desc":"T2 出境大廳右側，靠近 D 排報到區，24 小時；可快速解決午餐","desc_en":"Right side of T2 departure hall, near Row D check-in. Open 24 hours. Good for a fast lunch.","tags":["麥當勞","漢堡","速食","午餐","快餐","McDonald","burger","fast food","lunch"]},
    {"id":57, "name":"美食廣場",         "name_en":"Food Court",                     "category":"restaurant","terminal":"T1","floor":"3F",  "zone":"出境大廳（安檢前）","desc":"出境大廳左翼，台式便當、麵食、小吃多種選擇；午餐尖峰約 12:00–13:00，建議 11:30 前或 13:30 後前往","desc_en":"Left wing of T1 departure hall. Taiwanese bento, noodles, snacks. Peak 12:00–13:00 — go before 11:30 or after 13:30.","tags":["美食廣場","食堂","午餐","便當","台式","麵食","food court","lunch","bento"]},
    {"id":58, "name":"美食廣場",         "name_en":"Food Court",                     "category":"restaurant","terminal":"T2","floor":"3F",  "zone":"出境大廳", "desc":"T2 報到大廳中段，多家攤位並列；提供便當、牛肉麵、自助餐等，午餐 11:00–14:00","desc_en":"Mid-section of T2 departure hall. Multiple stalls: bento, beef noodles, buffet. Lunch 11:00–14:00.","tags":["美食廣場","食堂","午餐","便當","牛肉麵","自助餐","food court","lunch","noodles"]},
    {"id":59, "name":"7-Eleven 便當",    "name_en":"7-Eleven Bento",                 "category":"restaurant","terminal":"T1","floor":"3F",  "zone":"出境大廳（安檢前）","desc":"報到大廳 7-Eleven 提供加熱便當、關東煮、茶葉蛋；微波約 2 分鐘，快速解決午餐","desc_en":"7-Eleven in the departure hall offers heated bento boxes, oden, and tea eggs. ~2 min microwave, fast lunch fix.","tags":["便當","7-11","超商","午餐","快速","關東煮","bento","7-Eleven","convenience","lunch","quick"]},
    {"id":60, "name":"7-Eleven 便當",    "name_en":"7-Eleven Bento",                 "category":"restaurant","terminal":"T2","floor":"3F",  "zone":"出境大廳", "desc":"T2 報到大廳 7-Eleven，備有各式微波便當與飯糰；班表忙碌時的快速午餐首選","desc_en":"T2 departure hall 7-Eleven. Microwave bento and rice balls. Best quick-lunch option on busy shifts.","tags":["便當","7-11","超商","午餐","快速","飯糰","bento","7-Eleven","convenience","lunch","quick"]},
]
